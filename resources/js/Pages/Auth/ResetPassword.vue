...
<template>
    <GuestLayout>
        ...
        <div class="space-y-8">
            <div class="space-y-3">
                <p class="text-xs font-semibold uppercase tracking-[0.28em] text-[var(--maya-text-muted)]">Recuperación</p>
                <h1 class="text-3xl font-semibold tracking-tight text-[var(--maya-text-main)] sm:text-4xl">Establece una nueva contraseña</h1>
                <p class="max-w-xl text-sm leading-6 text-[var(--maya-text-muted)]">
                    Elige una contraseña nueva para terminar de restaurar el acceso a tu cuenta Maya.
                </p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-5">
                ...
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <p class="text-sm text-[var(--maya-text-muted)]">
                        Usa al menos una letra mayúscula, una minúscula y un número.
                    </p>
