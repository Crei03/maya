...
const submit = () => {
    ...
    })).post(route('Management.blog.store'));
};
</script>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
                <form @submit.prevent="submit" class="p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <TextInput
                                ...
                                required
                                placeholder="Ej: Nuevos servicios de envío"
                                @input="onTitleInput"
                            />
                    ...
                    <div class="flex items-center">
                        ...
                        />
                        <InputLabel for="is_published" value="Publicar inmediatamente" class="ml-2" />
                    </div>
